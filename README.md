...
2. Tech Stack 
* **Backend: .NET 8 Web API, C#, xUnit, FluentAssertions 
...
* **Styling: HTML5, CSS3 (Flexbox Layout)
...
7. How to Run Tests
  **Backend Unit Tests (.NET / xUnit)
    ...
    and state rollbacks:
     ...
     Bash - cd backend/TicTacToe.Tests
          - dotnet test
...
10. Clarifications and Assumptions
  **Undo and Scoreboard Behavior
    This application implements Option B: Allow Undo After Completion. 
